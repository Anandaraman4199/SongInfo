...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Lib/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Lib/taglib/include -IC:/Lib/taglib/include/taglib
if /i "%1#" == "--version#" echo 1.13
if /i "%1#" == "--prefix#"  echo C:/Lib/taglib
